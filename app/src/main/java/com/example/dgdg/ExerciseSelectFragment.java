...
public class ExerciseSelectFragment extends Fragment {
    ...
    private Button[] exButtons = {treadmill, cycle, Test, TESTtesttest};
    private int[] buttonIDs = {R.id.bt_ex1, R.id.bt_ex2, R.id.bt_ex3, R.id.bt_ex4};
    private String[] exNames = {"트레드밀", "사이클", "Test", "TESTttttttttttttttttttttttesttest"};
    private int[] exImages = {R.drawable.image_treadmill, R.drawable.image_cycle, R.drawable.image_test, R.drawable.image_test};
