...
public class ExercisingFragment extends Fragment {
    ...
    private static final String ARG_PARAM3 = "ex_record";

    private String ex_name;
    private int ex_image;
    private String ex_record;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            ex_record = getArguments().getString(ARG_PARAM3);
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        time_record=root.findViewById(R.id.time_record);

        ex_record=((TimerActivity)TimerActivity.context_main).machine_record;
        time_record.setText(ex_record);
